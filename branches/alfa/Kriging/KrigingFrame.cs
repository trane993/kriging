...
namespace Kriging
{
    public partial class KrigingFrame : Form
    {
        MainForm mForm = null;
        ...
        public KrigingFrame(MainForm mainForm)
        {
            InitializeComponent();
            mForm = mainForm;
        }
        ...
        public FreeImageBitmap tempbitmap = null;
        ...
        {
            KrigingXYZFrame kXYZFrame = new KrigingXYZFrame(mForm, this);
            kXYZFrame.ShowDialog();
